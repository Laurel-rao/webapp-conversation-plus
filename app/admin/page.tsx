      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-white font-bold">{stats?.userStats?.total || 0}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-blue-200">新用户</span>
              <span className="text-cyan-300 font-bold">{stats?.userStats?.new || 0}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-blue-200">活跃用户</span>
              <span className="text-green-300 font-bold">{stats?.userStats?.active || 0}</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-6">
          ...
          <div className="text-3xl font-bold text-teal-300 mb-2">
            ¥{stats?.revenueStats?.total?.toLocaleString() || 0}
          </div>
        ...
        <div className="glass-card p-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-white font-bold">{stats?.rechargeStats?.total || 0}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-blue-200">成功率</span>
              <span className="text-green-300 font-bold">{stats?.rechargeStats?.successRate || 0}%</span>
            </div>
            <div className="flex justify-between">
              <span className="text-blue-200">待处理</span>
              <span className="text-yellow-300 font-bold">{stats?.rechargeStats?.pending || 0}</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-6">
          ...
          <div className="text-3xl font-bold text-orange-300 mb-2">
            {stats?.consumptionStats?.total?.toLocaleString() || 0}
          </div>
          <div className="text-blue-200 text-sm">
            总消费积分
          </div>
